...
##
# VelocityPose Command - extends velocity commands with height and pose control
##


class UniformVelocityPoseCommand(UniformThresholdVelocityCommand):
...
@configclass
class UniformVelocityPoseCommandCfg(UniformThresholdVelocityCommandCfg):
    ...
    @configclass
    class Ranges(UniformThresholdVelocityCommandCfg.Ranges):
