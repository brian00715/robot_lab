...
class WbcRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    # Override commands with whole-body velocity and pose commands.
    ...
    def __post_init__(self):
        ...
        # Disable the inherited velocity curriculum: in robot_lab_raw v2.3.0 it is hardcoded to "base_velocity".
