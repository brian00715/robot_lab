...
- 70D observation space (dog + arm states)
...
from robot_lab.tasks.manager_based.wbc.wbc_env_cfg import (
    WbcRoughEnvCfg,
)
from robot_lab.tasks.manager_based.wbc.mdp.composite_actions import DogArmCompositeAction
...
class ArxX5WbcRoughEnvCfg(WbcRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # ========================================
        # Observations Configuration (70D total)
        # ========================================
        @configclass
        class GO2X5ObservationsCfg:
            """Unified 70D observation space for Stage 1."""

            @configclass
            class PolicyCfg(ObsGroup):
                """Policy observations (70D)."""
                ...
                combined_com_offset = ObsTerm(
                    ...
                    params={
                        ...
                        "dog_mass": 15.0,
                        "arm_mass": 3.0,
                        "arm_body_names": ["link1", "link2", "link3", "link4", "link5", "ee"]
                    }
                )  # 3D
        ...
        if self.__class__.__name__ in ["ArxX5WbcRoughEnvCfg", "ArxX5WbcFlatEnvCfg", "ArxX5WbcFlatPlayEnvCfg"]:
        ...
        # Enable height and pose curriculum for the WBC task.
